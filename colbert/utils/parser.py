...
class Arguments():
    ...
    def add_model_training_parameters(self):
        ...
        self.add_argument('--checkpoint_init', dest='checkpoint_init', default=False, action ='store_true')
        
        self.add_argument('--random_seed',dest="random_seed", default=12345, type = int)
        self.add_argument('--reg_lambda', dest='reg_lambda', default=0.01, type=float)
        ...
        self.add_argument('--in_batch_negs', dest='in_batch_negs', default=False,action='store_true')
        self.add_argument('--e2e', dest='e2e', default=False,action='store_true')
